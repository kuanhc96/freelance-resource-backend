...
public class LessonTranslator {
	public static GetLessonResponse toDto(LessonEntity lessonEntity) {
		return GetLessonResponse.builder()
				...
				.locationGUID(lessonEntity.getLocationGUID())
				.locationName(lessonEntity.getLocationName())
	...
	public static LessonEntity toEntity(GetLessonResponse response) {
		return LessonEntity.builder()
				...
				.locationGUID(response.getLocationGUID())
				.locationName(response.getLocationName())
				.subjectGUID(response.getSubjectGUID())
